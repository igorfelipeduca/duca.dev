...
export default function HighlightContent() {
  return (
    <>
      <div className="w-full h-96 bg-black rounded-lg text-white pl-16 lg:flex justify-between hidden">
        <div className="py-12">
          <div className="flex items-center">
            <h1 className="w-32 text-5xl font-bold">Behind this portfolio</h1>
          </div>
